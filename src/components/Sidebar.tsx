        ...
        <div className="py-4 text-gray-500 dark:text-gray-400">
          ...
          <div className="mt-6 flex flex-col items-center">
            <div className="relative">
              ...
              >
                <h1 className="text-sm font-semibold transition-colors duration-150">By Byte Buster</h1>
                <img src="\src\assets\_90779dd4-abd9-487a-b254-6c27b0a6989f-removebg-preview.png" alt="Logo" className="w-16 h-16 object-cover rounded-full mt-2" />
                {isHovered && (
                  <div className="absolute left-0 w-35 bg-white border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700 mt-2 rounded-lg">
                    <ul>
                      <li className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 .296c-6.63 0-12 5.37-12 12 0 5.304 3.438 9.8 8.205 11.385.6.111.82-.261.82-.581 0-.287-.011-1.049-.017-2.059-3.338.726-4.042-1.614-4.042-1.614-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.204.085 1.838 1.236 1.838 1.236 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.305-5.467-1.335-5.467-5.933 0-1.311.467-2.383 1.235-3.223-.124-.304-.536-1.528.116-3.184 0 0 1.008-.322 3.3 1.23.957-.266 1.984-.399 3.005-.403 1.02.004 2.048.137 3.006.403 2.291-1.553 3.298-1.23 3.298-1.23.654 1.656.242 2.88.118 3.184.77.84 1.235 1.912 1.235 3.223 0 4.61-2.806 5.625-5.475 5.921.43.372.813 1.103.813 2.222 0 1.605-.014 2.898-.014 3.293 0 .324.216.698.826.58 4.765-1.585 8.199-6.081 8.199-11.384 0-6.63-5.37-12-12-12z" />
                        </svg>
                       <a  target='_blank' href="https://github.com/TheDrianN">TheDrianN</a>
                      </li>
                      <li className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 .296c-6.63 0-12 5.37-12 12 0 5.304 3.438 9.8 8.205 11.385.6.111.82-.261.82-.581 0-.287-.011-1.049-.017-2.059-3.338.726-4.042-1.614-4.042-1.614-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.204.085 1.838 1.236 1.838 1.236 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.305-5.467-1.335-5.467-5.933 0-1.311.467-2.383 1.235-3.223-.124-.304-.536-1.528.116-3.184 0 0 1.008-.322 3.3 1.23.957-.266 1.984-.399 3.005-.403 1.02.004 2.048.137 3.006.403 2.291-1.553 3.298-1.23 3.298-1.23.654 1.656.242 2.88.118 3.184.77.84 1.235 1.912 1.235 3.223 0 4.61-2.806 5.625-5.475 5.921.43.372.813 1.103.813 2.222 0 1.605-.014 2.898-.014 3.293 0 .324.216.698.826.58 4.765-1.585 8.199-6.081 8.199-11.384 0-6.63-5.37-12-12-12z" />
                        </svg>
                        <a target='_blank' href="https://github.com/Ed-Ponk">PonkWard</a>
                      </li>
                      <li className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 .296c-6.63 0-12 5.37-12 12 0 5.304 3.438 9.8 8.205 11.385.6.111.82-.261.82-.581 0-.287-.011-1.049-.017-2.059-3.338.726-4.042-1.614-4.042-1.614-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.204.085 1.838 1.236 1.838 1.236 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.305-5.467-1.335-5.467-5.933 0-1.311.467-2.383 1.235-3.223-.124-.304-.536-1.528.116-3.184 0 0 1.008-.322 3.3 1.23.957-.266 1.984-.399 3.005-.403 1.02.004 2.048.137 3.006.403 2.291-1.553 3.298-1.23 3.298-1.23.654 1.656.242 2.88.118 3.184.77.84 1.235 1.912 1.235 3.223 0 4.61-2.806 5.625-5.475 5.921.43.372.813 1.103.813 2.222 0 1.605-.014 2.898-.014 3.293 0 .324.216.698.826.58 4.765-1.585 8.199-6.081 8.199-11.384 0-6.63-5.37-12-12-12z" />
                        </svg>
                        <a target='_blank' href="https://github.com/BeafLee">BeafLee</a>
                      </li>
                    </ul>
                  </div>
                )}
          ...
          <div className="mt-6 flex flex-col items-center">
            <div className="relative">
              ...
              >
                ...
                <img src="\src\assets\_90779dd4-abd9-487a-b254-6c27b0a6989f-removebg-preview.png" alt="Logo" className="w-16 h-16 object-cover rounded-full mt-2" />
                {isHovered && (
                  <div className="absolute left-0 w-48 bg-white border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700 mt-2 rounded-lg">
                    <ul>
                      <li className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M12 .296c-6.63 0-12 5.37-12 12 0 5.304 3.438 9.8 8.205 11.385.6.111.82-.261.82-.581 0-.287-.011-1.049-.017-2.059-3.338.726-4.042-1.614-4.042-1.614-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.204.085 1.838 1.236 1.838 1.236 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.305-5.467-1.335-5.467-5.933 0-1.311.467-2.383 1.235-3.223-.124-.304-.536-1.528.116-3.184 0 0 1.008-.322 3.3 1.23.957-.266 1.984-.399 3.005-.403 1.02.004 2.048.137 3.006.403 2.291-1.553 3.298-1.23 3.298-1.23.654 1.656.242 2.88.118 3.184.77.84 1.235 1.912 1.235 3.223 0 4.61-2.806 5.625-5.475 5.921.43.372.813 1.103.813 2.222 0 1.605-.014 2.898-.014 3.293 0 .324.216.698.826.58 4.765-1.585 8.199-6.081 8.199-11.384 0-6.63-5.37-12-12-12z" />
