...
const Sidebar: React.FC<SidebarProps> = ({ isSideMenuOpen, toggleSideMenu, currentPage, setCurrentPage }) => {
  const menuItems = [
    ...
    { name: 'Gestionar Grupos Horarios', icon: 'M16.5 8C17.3284 8 18 7.32843 18 6.5C18 5.67157 17.3284 5 16.5 5C15.6716 5 15 5.67157 15 6.5C15 7.32843 15.6716 8 16.5 8Z M8 14.5C9.10457 14.5 10 13.6046 10 12.5C10 11.3954 9.10457 10.5 8 10.5C6.89543 10.5 6 11.3954 6 12.5C6 13.6046 6.89543 14.5 8 14.5Z M21.95 12.79C21.72 9.53 19.24 7 16 7 M8 17C5.38 17 3.11 18.28 1.79 20.25C1.61 20.53 2.17 21 2.62 21H13.35C13.8 21 14.36 20.53 14.18 20.25C13.43 19.13 12.34 18.19 11.08 17.5 M17 19.01V21 M19 19.01V21 M23 19.01V21 M20.4 16.6C20.7314 16.2686 21.2686 16.2686 21.6 16.6C21.9314 16.9314 21.9314 17.4686 21.6 17.8C21.2686 18.1314 20.7314 18.1314 20.4 17.8C20.0686 17.4686 20.0686 16.9314 20.4 16.6 M15 19.01V21', page: 'Grupo' },
