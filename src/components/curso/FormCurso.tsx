...
const FormCurso: React.FC<FormCursoProps> = ({ selectedCurso, setSelectedCurso, fetchData }) => {
  ...
  return (
    <div className="flex flex-col mx-auto bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-200 rounded-xl shadow-md overflow-hidden p-5">
      <h1 className="block font-medium leading-6 mb-4">
          ...
          <div className='flex-1'>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md border-0 py-1.5  p-1 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div className='flex-1'>
            <label htmlFor="vigente" className="block text-sm font-medium leading-6">
              Vigente
            </label>
