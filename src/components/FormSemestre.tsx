...
export const FormSemestre: React.FC<FormSemestreProps> = ({ selectedSemestre, setSelectedSemestre, fetchData }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const endpoint = selectedSemestre ? `http://127.0.0.1:5000/semestres` : `http://127.0.0.1:5000/semestres/registro-semestre`;
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="flex space-x-4">
          <div className="flex-1">
            <label htmlFor="fecha_inicio" className="block text-sm font-medium leading-6 text-gray-900">
              Fecha de Inicio
            </label>
            <div className="mt-2">
              <input
          ...
          <div className="flex-1">
            <label htmlFor="fecha_fin" className="block text-sm font-medium leading-6 text-gray-900">
              Fecha de Fin
            </label>
            <div className="mt-2">
              <input
        ...
        <div className='flex space-x-4'>
          <div className='flex-1'>
            <label htmlFor="nombre_semestre" className="block text-sm font-medium leading-6 text-gray-900">
              Nombre del Semestre
            </label>
            <div className="mt-2">
              <input
